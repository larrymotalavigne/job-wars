  ...
  template: `
    @if (tutorialService.currentStep; as step) {
      <div
        ...
        [class.position-top]="step.position === 'top'"
        ...
        <div class="tutorial-bubble">
          <div class="tutorial-header">
            <span class="tutorial-step-count"
              >{{ tutorialService.currentStepIndex + 1 }}/{{ tutorialService.totalSteps }}</span
            >
          ...
          <div class="tutorial-actions">
            @if (step.waitFor === 'click') {
              <p-button
                ...
                size="small"
                (onClick)="tutorialService.advance()"
              />
            } @else {
