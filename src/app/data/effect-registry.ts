...
export const EFFECT_REGISTRY: CardEffects[] = [
    ...
    effects: [
      {
        ...
        target: TargetType.AllAllyJobs,
        value: 1,
        value2: 1,
        permanent: true,
        description: 'Tous les Metiers Informatique gagnent +1/+1',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        target: TargetType.EnemyTool,
        value: 0,
        description: 'Detruit tous les Outils adverses',
      },
    ],
  },
  // it-024: IDE Pro — "+1 Productivité à un Métier Informatique allié."
  {
    ...
    effects: [
      {
        type: EffectType.Buff,
        target: TargetType.AllyJob,
        value: 1,
        value2: 0,
        permanent: true,
        description: '+1 Productivite a un Metier allie',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value2: 0,
        permanent: true,
        description: 'Tous les Metiers Police gagnent +1/+0',
      },
      {
        type: EffectType.Tap,
        target: TargetType.EnemyJob,
        value: 0,
        description: 'Engage un Metier adverse',
      },
    ],
  },
  ...
  // up-001: Géomètre — "Quand embauché : Gagnez +1 Budget au prochain tour."
  {
    ...
    trigger: EffectTrigger.OnHire,
    effects: [
      { type: EffectType.Budget, target: TargetType.None, value: 1, description: '+1 Budget' },
    ],
  },
    ...
    effects: [
      {
        ...
        value: 0,
        value2: 1,
        description: 'Tous vos Metiers gagnent +0/+1 ce tour',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value2: 2,
        permanent: true,
        description: 'Tous les Metiers Urbanisme gagnent +0/+2',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value2: 0,
        permanent: true,
        description: '+1/+0 a un Metier allie',
      },
      { type: EffectType.Draw, target: TargetType.None, value: 1, description: 'Pioche 1 carte' },
    ],
  },
    ...
    effects: [
      {
        ...
        value2: 1,
        permanent: true,
        description: '+0/+1 permanent a un Metier allie',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value2: 1,
        permanent: true,
        description: 'Tous les Metiers Artisanat gagnent +1/+1',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        target: TargetType.AnyJob,
        value: 1,
        description: 'Inflige 1 degat a un Metier cible',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value: 1,
        description: 'Restaure 1 Reputation',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value2: 0,
        permanent: true,
        description: 'Tous les Metiers Enseignement gagnent +1/+0',
      },
      {
        type: EffectType.Heal,
        target: TargetType.None,
    ...
    effects: [
      {
        ...
        value: 1,
        value2: 1,
        description: 'Tous les Metiers Enseignement gagnent +1/+1 ce tour',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value2: 0,
        permanent: true,
        description: '+1/+0 permanent a un Metier allie',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        target: TargetType.None,
        value: 2,
        description: 'Restaure 2 Reputation',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        target: TargetType.AnyJob,
        value: 2,
        description: 'Inflige 2 degats a un Metier cible',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        target: TargetType.None,
        value: 3,
        description: 'Restaure 3 Reputation',
      },
      { type: EffectType.Draw, target: TargetType.None, value: 1, description: 'Pioche 1 carte' },
    ],
  },
    ...
    effects: [
      {
        ...
        value2: 0,
        permanent: true,
        description: 'Tous les Metiers Armee gagnent +1/+0',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value2: 1,
        permanent: true,
        description: 'Tous les Metiers Armee gagnent +1/+1',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value: 1,
        value2: 1,
        description: '+1/+1 a un Metier Armee allie ce tour',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value: 0,
        value2: 2,
        description: '+0/+2 a un Metier allie',
      },
      { type: EffectType.Draw, target: TargetType.None, value: 1, description: 'Pioche 1 carte' },
    ],
  },
  // mi-035: Embuscade — "Infligez 2 dégâts à chaque Métier attaquant."
  {
    ...
    effects: [
      {
        type: EffectType.Damage,
        target: TargetType.AllEnemyJobs,
        value: 2,
        description: 'Inflige 2 degats a chaque Metier attaquant',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value2: 0,
        permanent: true,
        description: '-1/-0 permanent a un Metier adverse',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value2: 2,
        permanent: true,
        description: 'Tous les Metiers Justice gagnent +0/+2',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        target: TargetType.EnemyTool,
        value: 0,
        description: 'Detruit un Outil adverse',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value2: 1,
        permanent: true,
        description: 'Les Metiers Pompiers gagnent +1/+1',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value: 1,
        value2: 0,
        description: '+1/+0 a un Metier Pompier allie ce tour',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value2: 0,
        permanent: true,
        description: '+2/+0 a un Metier allie',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value: 2,
        value2: 0,
        description: 'Tous les Metiers Pompiers gagnent +2/+0 ce tour',
      },
    ],
  },
    ...
    effects: [
      {
        ...
        value2: 0,
        permanent: true,
        description: 'Tous les Metiers Finance gagnent +1/+0',
      },
    ],
  },
  {
    ...
    trigger: EffectTrigger.OnTurnStart,
    effects: [
      { type: EffectType.Budget, target: TargetType.None, value: 2, description: '+2 Budget' },
    ],
  },
    ...
    effects: [
      {
        ...
        value2: 1,
        permanent: true,
        description: '+1/+1 permanent a un Metier cible',
      },
    ],
  },
];
